...
public class UserFunctions {
    ...
    private static String loginURL = "http://192.168.1.2/ToDoApp/index.php";
    private static String registerURL = "http://192.168.1.2/ToDoApp/index.php";
    private static String forpassURL = "http://192.168.1.2/ToDoApp/index.php";
    private static String chgpassURL = "http://192.168.1.2/ToDoApp/index.php";
